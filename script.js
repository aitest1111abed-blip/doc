...
/* ===== Main App ===== */
    ...
    window.closePatientDetailsModal = () => document.getElementById('patientDetailsModal').classList.add('hidden');
    ...
    function renderHomeSection() {
      ...
      try {
        ...
        // بطاقات قسم المواعيد المؤكدة (أسفل الروزنامة)
        setText('calStatTotal', totalToday);
        setText('calStatRem', accepted.length);
        setText('calStatVis', visited.length);
        setText('calStatAbs', noShow.length);
...
/* ===== Custom Alert & Contacts ===== */
  ...
  window.docbookSignOut = function() { /* معطّل عمداً */ };
